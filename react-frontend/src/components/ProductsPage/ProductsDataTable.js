...
const ProductsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const tickTemplate3 = (rowData, { rowIndex }) => <i className={`pi ${rowData.isAvailable?"pi-check": "pi-times"}`}  ></i>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="isAvailable" header="Availability" body={tickTemplate3} style={{ minWidth: "8rem" }} />
